'use strict';
const zmq = require('zeromq'), cluster = require('cluster');
const IPC_JOBS = 'tcp://127.0.0.1:60401', IPC_MESSAGES = 'tcp://127.0.0.1:60402';

// spawn 3 worker processes (gerar 3 processos de trabalho)
  ...
  puller.on('message', function (data) {
    ...
    if(!parsed || !parsed.type){
      ...
      if(parsed.type === 'ready'){
        ...
        console.log('resultado carai',parsed);
      } else {
